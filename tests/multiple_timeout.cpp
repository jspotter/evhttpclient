/*
 * multiple_timeout.cpp
 *
 * Makes many requests. Does not display responses, but
 * checks that they look acceptable. This time, use a timeout.
 */
...
void response_cb(ResponseInfo *response, void *requestData, void *clientData)
{
	...
	{
		cout << "Done." << endl;
		cout << "Timeouts: " << num_timeouts << endl;
...
int main()
{
	...
	EvHttpClient client(loop, "http://www.greenhondacivicsunite.com/", TIMEOUT, NULL);
